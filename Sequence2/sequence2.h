...
//		POstcondition: A copy of source is made. First the parameters used and capacity from source are copied
//	    then dynamic memory is allocated with pointer data using the copied capacity. 
//		Finally, each existing element in the sequence source is copied to the newly created array
